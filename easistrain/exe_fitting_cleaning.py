...
if len(sys.argv) != 11 or sys.argv[1] == "help":
    print(
        "#### Arguments to be given: 1)root // 2)h5file // 3) scan // 4)tth_min // 5)tth_max // 6)bgd_left // 7)bgd_right // 8)fitting function:PVII, gauss, Lorentz or Ps // 9)hkl // 10)Rp:godness of fit"
    )
else:
