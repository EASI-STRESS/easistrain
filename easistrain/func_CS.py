...
def bccslit(ap,sddistance,slitopening,beamsize,pixelsize, title):
    ...
    veraxis01=np.array([0.001*sltr11050,0.001*sltr11060,0.001*sltr11070,0.001*sltr11080,0.001*sltr11090,0.001*sltr110100])
    legends01=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis01,veraxis01,'energy (keV)','slitradius110 (mm)','-',legends01,'radius_BCC (110)', title + ' (110)')
    ### Plotting of the radius for the 200 peak ###
    horaxis02=np.array([energy,energy,energy,energy,energy,energy])
    veraxis02=np.array([0.001*sltr20050,0.001*sltr20060,0.001*sltr20070,0.001*sltr20080,0.001*sltr20090,0.001*sltr200100])
    legends02=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis02,veraxis02,'energy (keV)','slitradius200 (mm)','-',legends02,'radius_BCC (200)', title + ' (200)')
    ### Plotting of the radius for the 211 peak ###
    horaxis03=np.array([energy,energy,energy,energy,energy,energy])
    veraxis03=np.array([0.001*sltr21150,0.001*sltr21160,0.001*sltr21170,0.001*sltr21180,0.001*sltr21190,0.001*sltr211100])
    legends03=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis03,veraxis03,'energy (keV)','slitradius211 (mm)','-',legends03,'radius_BCC (211)', title + ' (211)')
    ### Plotting of the radius for the 220 peak ###
    horaxis04=np.array([energy,energy,energy,energy,energy,energy])
    veraxis04=np.array([0.001*sltr22050,0.001*sltr22060,0.001*sltr22070,0.001*sltr22080,0.001*sltr22090,0.001*sltr220100])
    legends04=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis04,veraxis04,'energy (keV)','slitradius220 (mm)','-',legends04,'radius_BCC (220)', title + ' (220)')
    ### Plotting of the radius for the 310 peak ###
    horaxis05=np.array([energy,energy,energy,energy,energy,energy])
    veraxis05=np.array([0.001*sltr31050,0.001*sltr31060,0.001*sltr31070,0.001*sltr31080,0.001*sltr31090,0.001*sltr310100])
    legends05=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis05,veraxis05,'energy (keV)','slitradius310 (mm)','-',legends05,'radius_BCC (310)', title + ' (310)')
    ### Plotting of the radius for the 222 peak ###
    horaxis06=np.array([energy,energy,energy,energy,energy,energy])
    veraxis06=np.array([0.001*sltr22250,0.001*sltr22260,0.001*sltr22270,0.001*sltr22280,0.001*sltr22290,0.001*sltr222100])
    legends06=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis06,veraxis06,'energy (keV)','slitradius222 (mm)','-',legends06,'radius_BCC (222)', title + ' (222)')
    ### Plotting of the radius for the 321 peak ###
    horaxis07=np.array([energy,energy,energy,energy,energy,energy])
    veraxis07=np.array([0.001*sltr32150,0.001*sltr32160,0.001*sltr32170,0.001*sltr32180,0.001*sltr32190,0.001*sltr321100])
    legends07=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis07,veraxis07,'energy (keV)','slitradius321 (mm)','-',legends07,'radius_BCC (321)', title + ' (321)')
    ### Plotting of the radius for the 400 peak ###
    horaxis08=np.array([energy,energy,energy,energy,energy,energy])
    veraxis08=np.array([0.001*sltr40050,0.001*sltr40060,0.001*sltr40070,0.001*sltr40080,0.001*sltr40090,0.001*sltr400100])
    legends08=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis08,veraxis08,'energy (keV)','slitradius211 (mm)','-',legends08,'radius_BCC (400)', title + ' (400)')
    ...
    legends11=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis11,veraxis11,'energy (keV)','gauge volume length 110 (μm)','-',legends11,'gvl_BCC (110)', title + ' (110)')
    ...
    legends12=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis12,veraxis12,'energy (keV)','gauge volume length 200 (μm)','-',legends12,'gvl_BCC (200)', title + ' (200)')
    ...
    legends13=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis13,veraxis13,'energy (keV)','gauge volume length 211 (μm)','-',legends13,'gvl_BCC (211)', title + '(211)')
    ...
    legends14=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis14,veraxis14,'energy (keV)','gauge volume length 220 (μm)','-',legends14,'gvl_BCC (220)', title + ' (220)')
    ...
    legends15=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis15,veraxis15,'energy (keV)','gauge volume length 310 (μm)','-',legends15,'gvl_BCC (310)', title + ' (310)')
    ...
    legends16=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis16,veraxis16,'energy (keV)','gauge volume length 222 (μm)','-',legends16,'gvl_BCC (222)', title + '(222)')
    ...
    legends17=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis17,veraxis17,'energy (keV)','gauge volume length 321 (μm)','-',legends17,'gvl_BCC (321)', title + ' (321)')
    ...
    legends18=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis18,veraxis18,'energy (keV)','gauge volume length 400 (μm)','-',legends18,'gvl_BCC (400)', title + ' (400)')
    ### Plotting of the radius of all planes for one slit to sample distance
    horaxis09=np.array([energy,energy,energy,energy,energy,energy,energy,energy])
    veraxis09=np.array([0.001*sltr110100,0.001*sltr200100,0.001*sltr211100,0.001*sltr220100,0.001*sltr310100,0.001*sltr222100,0.001*sltr321100,0.001*sltr400100])
    legends09=np.array(['(110)','(200)','(211)','(220)','(310)','(222)','(321)','(400)'])
    showplot(horaxis09,veraxis09,'energy (keV)','slit radius (mm)','-',legends09,'radius_BCC_lss100mm', title)
    ### Plotting of the length of the gauge volume of all planes for one slit to sample distance
    horaxis19=np.array([energy,energy,energy,energy,energy,energy,energy,energy])
    veraxis19=np.array([gvl110100,gvl200100,gvl211100,gvl220100,gvl310100,gvl222100,gvl321100,gvl400100])
    legends19=np.array(['(110)','(200)','(211)','(220)','(310)','(222)','(321)','(400)'])
    showplot(horaxis19,veraxis19,'energy (keV)','gauge volume length (μm)','-',legends19,'gvl_BCC_lss100mm', title)
    return
...
def fccslit(ap,sddistance,slitopening,beamsize,pixelsize,title):
    ...
    veraxis21=np.array([0.001*sltr11150,0.001*sltr11160,0.001*sltr11170,0.001*sltr11180,0.001*sltr11190,0.001*sltr111100])
    legends21=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis21,veraxis21,'energy (keV)','slitradius111 (mm)','-',legends21,'radius_FCC (111)', title + ' (111)')
    ### Plotting of the radius for the 200 peak ###
    horaxis22=np.array([energy,energy,energy,energy,energy,energy])
    veraxis22=np.array([0.001*sltr20050,0.001*sltr20060,0.001*sltr20070,0.001*sltr20080,0.001*sltr20090,0.001*sltr200100])
    legends22=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis22,veraxis22,'energy (keV)','slitradius200 (mm)','-',legends22,'radius_FCC (200)', title + ' (200)')
    ### Plotting of the radius for the 220 peak ###
    horaxis23=np.array([energy,energy,energy,energy,energy,energy])
    veraxis23=np.array([0.001*sltr22050,0.001*sltr22060,0.001*sltr22070,0.001*sltr22080,0.001*sltr22090,0.001*sltr220100])
    legends23=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis23,veraxis23,'energy (keV)','slitradius220 (mm)','-',legends23,'radius_FCC (220)', title + ' (220)')
    ### Plotting of the radius for the 311 peak ###
    horaxis24=np.array([energy,energy,energy,energy,energy,energy])
    veraxis24=np.array([0.001*sltr31150,0.001*sltr31160,0.001*sltr31170,0.001*sltr31180,0.001*sltr31190,0.001*sltr311100])
    legends24=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis24,veraxis24,'energy (keV)','slitradius311 (mm)','-',legends24,'radius_FCC (311)',title + '(311)')
    ### Plotting of the radius for the 222 peak ###
    horaxis25=np.array([energy,energy,energy,energy,energy,energy])
    veraxis25=np.array([0.001*sltr22250,0.001*sltr22260,0.001*sltr22270,0.001*sltr22280,0.001*sltr22290,0.001*sltr222100])
    legends25=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis25,veraxis25,'energy (keV)','slitradius222 (mm)','-',legends25,'radius_FCC (222)', title + ' (222)')
    ### Plotting of the radius for the 400 peak ###
    horaxis26=np.array([energy,energy,energy,energy,energy,energy])
    veraxis26=np.array([0.001*sltr40050,0.001*sltr40060,0.001*sltr40070,0.001*sltr40080,0.001*sltr40090,0.001*sltr400100])
    legends26=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis26,veraxis26,'energy (keV)','slitradius400 (mm)','-',legends26,'radius_FCC (400)', title + ' (400)')
    ### Plotting of the radius for the 331 peak ###
    horaxis27=np.array([energy,energy,energy,energy,energy,energy])
    veraxis27=np.array([0.001*sltr33150,0.001*sltr33160,0.001*sltr33170,0.001*sltr33180,0.001*sltr33190,0.001*sltr331100])
    legends27=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis27,veraxis27,'energy (keV)','slitradius331 (mm)','-',legends27,'radius_FCC (331)', title + ' (331)')
    ### Plotting of the radius for the 420 peak ###
    horaxis28=np.array([energy,energy,energy,energy,energy,energy])
    veraxis28=np.array([0.001*sltr42050,0.001*sltr42060,0.001*sltr42070,0.001*sltr42080,0.001*sltr42090,0.001*sltr420100])
    legends28=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis28,veraxis28,'energy (keV)','slitradius420 (mm)','-',legends28,'radius_FCC (420)', title + ' (420)')
    ### Plotting of the radius for the 422 peak ###
    horaxis29=np.array([energy,energy,energy,energy,energy,energy])
    veraxis29=np.array([0.001*sltr42250,0.001*sltr42260,0.001*sltr42270,0.001*sltr42280,0.001*sltr42290,0.001*sltr422100])
    legends29=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis29,veraxis29,'energy (keV)','slitradius422 (mm)','-',legends29,'radius_FCC (422)', title + ' (422)')
    ...
    legends31=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis31,veraxis31,'energy (keV)','gauge volume length 111 (μm)','-',legends31,'gvl_FCC (111)',title + ' (111)')
    ### Plotting of the gauge volume length for the 200 peak ###
    ...
    legends32=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis32,veraxis32,'energy (keV)','gauge volume length 200 (μm)','-',legends32,'gvl_FCC (200)', title + ' (200)')
    ### Plotting of the gauge volume length for the 220 peak ###
    ...
    legends33=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis33,veraxis33,'energy (keV)','gauge volume length 220 (μm)','-',legends33,'gvl_FCC (220)', title + ' (220)')
    ...
    legends34=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis34,veraxis34,'energy (keV)','gauge volume length 311 (μm)','-',legends34,'gvl_FCC (311)', title + ' (311)')
    ### Plotting of the gauge volume length for the 222 peak ###
    ...
    legends35=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis35,veraxis35,'energy (keV)','gauge volume length 222 (μm)','-',legends35,'gvl_FCC (222)', title + ' (222)')
    ### Plotting of the gauge volume length for the 400 peak ###
    ...
    legends36=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis36,veraxis36,'energy (keV)','gauge volume length 400 (μm)','-',legends36,'gvl_FCC (400)', title + ' (400)')
    ...
    legends37=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis37,veraxis37,'energy (keV)','gauge volume length 331 (μm)','-',legends37,'gvl_FCC (331)', title + ' (331)')
    ...
    legends38=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis38,veraxis38,'energy (keV)','gauge volume length 420 (μm)','-',legends38,'gvl_FCC (420)', title + ' (420)')
    ...
    legends39=np.array(['lss = 50 mm','lss = 60 mm','lss = 70 mm','lss = 80 mm','lss = 90 mm','lss = 100 mm'])
    showplot(horaxis39,veraxis39,'energy (keV)','gauge volume length 422 (μm)','-',legends39,'gvl_FCC (422)', title + ' (422)')
    ### Plotting of the radius of all planes for one slit to sample distance
    horaxis029=np.array([energy,energy,energy,energy,energy,energy,energy,energy,energy])
    veraxis029=np.array([0.001*sltr111100,0.001*sltr200100,0.001*sltr220100,0.001*sltr311100,0.001*sltr222100,0.001*sltr400100,0.001*sltr331100,0.001*sltr420100,0.001*sltr422100,])
    legends029=np.array(['(111)','(200)','(220)','(311)','(222)','(400)','(331)','(420)','(422)'])
    showplot(horaxis029,veraxis029,'energy (keV)','slitradius(mm)','-',legends029,'radius_FCC_lss100mm', title)
    ### Plotting of the gauge volume length of all planes for one slit to sample distance
    horaxis029=np.array([energy,energy,energy,energy,energy,energy,energy,energy,energy])
    veraxis029=np.array([gvl111100,gvl200100,gvl220100,gvl311100,gvl222100,gvl400100,gvl331100,gvl420100,gvl422100,])
    legends029=np.array(['(111)','(200)','(220)','(311)','(222)','(400)','(331)','(420)','(422)'])
    showplot(horaxis029,veraxis029,'energy (keV)','gauge volume length (μm)','-',legends029,'gvl_FCC_lss100mm', title)
    return
